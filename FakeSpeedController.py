...
class SpeedController:
    def __init__(self, simulator, motor_handles, simulation_step_time, base_car):
        ...
        self.speed = 0
        self.min_speed = 0
        self.deceleration_step = 0.8  # TODO make this dependent on time step (on real Turbodroid it is 0.1)
        self.acceleration_step = 0.8  # TODO make this dependent on time step
        self.speed_target = 0
